                    ...
                    <VCardText class="d-flex justify-space-between">
                        <div>
                            <div class="d-flex align-center gap-2 my-1">
                                <span class="font-weight-semibold">{{$t("role_and_permission")}}</span>
                            </div>
                            <span>
                                <VBreadcrumbs class="pl-0">
                                    ...
                                    <VBreadcrumbsItem>{{$t("role_and_permission")}}</VBreadcrumbsItem>
                                </VBreadcrumbs>
                            </span>
                        </div>
                    </VCardText>
                        ...
                        <VRow>
                            ...
                            >
                                <VBtn
                                   ...
                                   :to="{name:'content-management-add'}"
                                >
                                    Add 
                                </VBtn>
                            </VCol>
                        ...
                        >
                            ...
                            <td class="text-center">
                              <VBtn
                                ...
                                color="default"
                                size="x-small"
                                :to="{ name: 'content-management-edit-id', params: { id: user.id } }"
                              >
                                <VIcon
                                  icon="tabler-pencil"
                                  :size="22"
