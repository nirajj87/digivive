...
const isInfoDrawerVisible = ref(true)
  ...
  <VCard>
   ...
   <div class="text-center">
       ...
       <VTab
         ...
         :to="!item.category? { name: 'edit-profile-tab-uid', params: {tab: item.tab,uid:userId} } : { name: 'advance-setting-tab-category-userid-sub_tab', params: {tab: item.tab,category:item.category,userid:userId,sub_tab:subTab.value} }"
