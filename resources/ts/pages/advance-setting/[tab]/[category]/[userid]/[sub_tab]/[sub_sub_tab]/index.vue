...
// alert(subTab.value)
  ...
  { title: 'advance_setting', icon: 'tabler-settings', tab: 'edit',category:categoryTab.value,subtab:subTab.value,subSubTab:subSubTab.value},
]
  ...
  <VCard>
   ...
   <div class="text-center">
       ...
       <VTab
         ...
         :to="!item.category? { name: 'edit-profile-tab-uid', params: {tab: item.tab,uid:userId} } : { name: 'advance-setting-tab-category-userid-sub_tab-sub_sub_tab', params: {tab: item.tab,category:item.category,userid:userId,sub_tab:item.subtab,sub_sub_tab:item.subSubTab} }"
