...
import type {ViewerRatingList} from './types'
import axios from '@axios';

const BASE_URL = '/api/v1/viewer-rating';
...
export const useViewerRatingStore = defineStore('ViewerRatingStore',{
actions: {

    //fetch all
    fetchList(params: ViewerRatingList) {
    ...
    // add module data
    add(moduleData:ViewerRatingList) {
    ...
    // update module data
    update(moduleData:ViewerRatingList) {
        return new Promise((resolve,reject)=>{
