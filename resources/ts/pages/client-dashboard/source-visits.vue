...
<template>
    <section>
        <VCard title="Source Visits" subtitle="38.4k Visitors">
            <VCardText>
                <VList class="card-list">
                    <VListItem v-for="visit in sourceVisits" :key="visit.title">
                        <template #prepend>
                            <VAvatar size="34" color="secondary" variant="tonal" rounded>
                        ...
                        <template #append>
                            <div class="d-flex align-center">
                                ...
                                <VChip label :color="visit.profitLoss > 0 ? 'success' : 'error'">
                                    {{ visit.profitLoss > 0 ? '+' : '' }}
                                    {{ visit.profitLoss }}%
                                </VChip>
                            </div>
