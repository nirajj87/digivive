            ...
            >
                ...
                >
                    <VCardText>
                        <VRow>
                            <VCol cols="12">
                                <h6 class="text-h6 text-white mb-1">Website Analytics</h6>
                                <p class="text-sm mb-0 text-white">Total 28.5% Conversion Rate</p>
                            </VCol>
                            <VCol cols="12" sm="6" order="2" order-sm="1">
                                <VRow>
                                    <VCol cols="12" class="pb-0">
                                        <p class="font-weight-semibold text-white">{{ item.name }}</p>
                                    </VCol>
                                    <VCol
